...
fun Int.getStringRes(vararg params: String?): String {
    return App.context.getString(this, *params)
}

fun Int.getDimen(): Int {
    return App.context.resources.getDimensionPixelSize(this)
}

fun Int.getDrawable(): Drawable? {
    return ContextCompat.getDrawable(App.context, this)
}
...
fun BottomSheetBehavior<*>.addCallback(onSlide: ((slideOffset: Float) -> Unit)?, onStateChanged: ((bottomSheet: View, newState: Int) -> Unit)?) {
